...
st.header("Global")
st.markdown("Confirmed: "  + str(confirmed_total))
st.markdown("Deaths: " + str(death_total))
st.markdown("Recovered: " + str(recovered_total))
st.markdown("Active: " + str(active_total))
...
st.header("Malaysia")
st.markdown("Confirmed: "  + str(confirmed_malaysia))
st.markdown("Deaths: " + str(death_malaysia))
st.markdown("Recovered: " + str(recovered_malaysia))
st.markdown("Active: " + str(active_malaysia))
